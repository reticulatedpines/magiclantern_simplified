...
static struct mpu_init_spell mpu_init_spells_500D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        { 0x0a, 0x08, 0x03, 0x2f, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #1.1, PROP_SPECIAL_OPTION */
        { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 },                 /* reply #1.2, PROP_CARD_EXTENSION */
        { 0x08, 0x07, 0x01, 0x33, 0x00, 0x00, 0x00, 0x00 },     /* reply #1.3, PROP 80000029 */
        { 0x14, 0x12, 0x02, 0x04, 0x0d, 0x01, 0x01, 0x00, 0x02, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #1.4, PROP_CFN */
        { 0x06, 0x05, 0x01, 0x20, 0x00, 0x00 },                 /* reply #1.5, PROP_CARD1_EXISTS */
        { 0x06, 0x05, 0x01, 0x21, 0x01, 0x00 },                 /* reply #1.6, PROP_CARD2_EXISTS */
        ...
        { 0x06, 0x05, 0x01, 0x2e, 0x01, 0x00 },                 /* reply #1.14, PROP_SAVE_MODE */
        { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 },                 /* reply #1.15, PROP_CARD_EXTENSION */
        { 0x06, 0x05, 0x01, 0x2c, 0x02, 0x00 },                 /* reply #1.16, PROP_CURRENT_MEDIA */
        { 0x06, 0x05, 0x03, 0x20, 0x00, 0x00 },                 /* reply #1.17, PROP_STARTUP_CONDITION */
        { 0x06, 0x05, 0x01, 0x42, 0x00, 0x00 },                 /* reply #1.18, PROP_PHOTO_STUDIO_MODE */
        { 0x06, 0x05, 0x01, 0x43, 0x00, 0x00 },                 /* reply #1.19, PROP 80040017 */
        { 0x06, 0x05, 0x01, 0x44, 0x00, 0x00 },                 /* reply #1.20, PROP 80040018 */
        { 0x06, 0x05, 0x01, 0x46, 0x00, 0x00 },                 /* reply #1.21, PROP_PHOTO_STUDIO_ENABLE_ISOCOMP */
        { 0x06, 0x05, 0x01, 0x48, 0x01, 0x00 },                 /* reply #1.22, PROP_LIVE_VIEW_MOVIE_SELECT */
        { 0x06, 0x05, 0x01, 0x49, 0x01, 0x00 },                 /* reply #1.23, PROP_LIVE_VIEW_AF_SYSTEM */
        ...
        { 0x2c, 0x2a, 0x02, 0x00, 0x03, 0x03, 0x03, 0x00, 0x03, 0x00, 0x00, 0x48, 0x01, 0x00, 0x00, 0x0a, 0x8c, 0x00, 0x00, 0x00, 0x00, 0x83, 0x06, 0x00, 0x00, 0x04, 0x06, 0x00, 0x00, 0x04, 0x06, 0x00, 0x00, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x24, 0xaa },/* reply #1.27, Init group */
        { 0x06, 0x05, 0x03, 0x04, 0x00, 0x00 },                 /* reply #1.28, PROP_POWER_KIND */
        { 0x06, 0x05, 0x03, 0x05, 0x01, 0x00 },                 /* reply #1.29, PROP_POWER_LEVEL */
        { 0x1e, 0x1c, 0x03, 0x30, 0x1b, 0x1b, 0x21, 0x65, 0x65, 0x65, 0x47, 0x65, 0x10, 0x3a, 0x10, 0x3a, 0x10, 0x3a, 0x00, 0x1d, 0x00, 0x1d, 0x00, 0x1d, 0x00, 0x1d, 0x00, 0x00, 0x00 },/* reply #1.30, PROP 8003002A */
        { 0x06, 0x05, 0x01, 0x38, 0x00, 0x00 },                 /* reply #1.31, PROP 80040005 */
        { 0x06, 0x05, 0x01, 0x39, 0x00, 0x00 },                 /* reply #1.32, PROP 80040006 */
        { 0x0c, 0x0b, 0x01, 0x0a, 0x00, 0x79, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #1.33, PROP_AFPOINT */
        { 0x0e, 0x0c, 0x03, 0x2e, 0x00, 0x00, 0x22, 0x81, 0x00, 0x00, 0x26, 0x89, 0x00 },/* reply #1.34, PROP_SHUTTER_COUNTER */
        { 0x0a, 0x08, 0x03, 0x2f, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #1.35, PROP_SPECIAL_OPTION */
        { 0x06, 0x05, 0x03, 0x23, 0x01, 0x00 },                 /* reply #1.36 */
        { 0x06, 0x05, 0x03, 0x24, 0x00, 0x00 },                 /* reply #1.37, PROP_LENS_NAME:  */
        { 0x06, 0x04, 0x03, 0x25, 0x00 },                       /* reply #1.38 */
        { 0x08, 0x06, 0x01, 0x45, 0x00, 0x10, 0x00 },           /* reply #1.39, PROP_METERING_TIMER_FOR_LV */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x02, 0x0a, 0x00, 0x00 }, .description = "PROP_PERMIT_ICU_EVENT", .out_spells = { /* spell #15 */
        { 0x06, 0x05, 0x03, 0x37, 0x00, 0x00 },                 /* reply #15.1, PROP_MIRROR_DOWN_IN_MOVIE_MODE */
        { 0x0a, 0x08, 0x03, 0x00, 0x4a, 0x00, 0x00, 0x01, 0x00 },/* reply #15.2, PROP 80030000 */
        { 0x14, 0x12, 0x03, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #15.3, PROP_LENS */
        { 0x06, 0x05, 0x03, 0x17, 0x9a, 0x00 },                 /* reply #15.4, PROP_EFIC_TEMP */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x09, 0x11, 0x01, 0x00 }, .description = "PROP_LV_DISPSIZE", .out_spells = { /* spell #19 */
        { 0 } } },
    { { 0x08, 0x06, 0x03, 0x18, 0x00, 0x00, 0x00 }, .description = "PROP 8003000F", .out_spells = { /* spell #20 */
        { 0 } } },
    { { 0x08, 0x06, 0x03, 0x1f, 0x00, 0x00, 0x00 }, .description = "PROP 80030019", .out_spells = { /* spell #21 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x13, 0x00, 0x00 }, .description = "PROP_LOGICAL_CONNECT", .out_spells = { /* spell #22 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x1e, 0x00, 0x00 }, .description = "PROP 8003001A", .out_spells = { /* spell #23 */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x03, 0x19, 0x01, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #25 */
        { 0 } } },
    { { 0x06, 0x05, 0x02, 0x0a, 0x01, 0x00 }, .description = "PROP_PERMIT_ICU_EVENT", .out_spells = { /* spell #26 */
