...
void RedrawBatteryIcon()
{
	...
	int x = DISPLAY_BATTERY_POS_X+26; int y = DISPLAY_BATTERY_POS_Y-16; int w = 12;
	bmp_fill((bat_info.performance<1 ? COLOR_GRAY50 : COLOR_GREEN2),x,y,w,w);
	bmp_fill((bat_info.performance<2 ? COLOR_GRAY50 : COLOR_GREEN2),x+4+w,y,w,w);
	bmp_fill((bat_info.performance<3 ? COLOR_GRAY50 : COLOR_GREEN2),x+8+2*w,y,w,w);
}
