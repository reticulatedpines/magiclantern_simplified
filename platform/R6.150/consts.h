...
#define CARD_LED_ADDRESS            0xD22390C2   /* base on work by coon */
...
#define BR_DCACHE_CLN_2     0xE004008E   /* second call to dcache_clean, before cstart */
#define BR_ICACHE_INV_2     0xE0040098   /* second call to icache_invalidate, before cstart */
#define BR_BR_CSTART        0xE00400AE   // indirect branch to cstart; the first branch is
                                         // absolute to original, we must patch
#define BR_BZERO32          0xE0040138   /* called from cstart */
#define BR_CREATE_ITASK     0xE004019A   /* called from cstart */

// This block no longer required but left for reference (may be removed later). lorenzo = not updated
