...
static struct mpu_init_spell mpu_init_spells_600D[] = { {
    ...
    { 0x08, 0x06, 0x01, 0x24, 0x00, 0x01, 0x00 }, {             /* spell #11 */
        ...
        { 0 } } }, {
    { 0x08, 0x06, 0x01, 0x27, 0x00, 0x64, 0x00 }, {             /* spell #12, PROP_CARD1_FOLDER_NUMBER(100) */
        { 0 } } }, {
    { 0x08, 0x07, 0x01, 0x2a, 0x24, 0xdf, 0x00, 0x00 }, {       /* spell #13, PROP_CARD2_FILE_NUMBER(9439) */
        { 0 } } }, {
    { 0x06, 0x05, 0x03, 0x07, 0x0b, 0x00 }, {                   /* spell #14, PROP_BURST_COUNT(11) */
        { 0 } } }, {
    ...
    { 0x06, 0x05, 0x03, 0x1e, 0x00, 0x00 }, {                   /* spell #31 */
        { 0 } } }, {
    { 0x08, 0x07, 0x01, 0x2a, 0x24, 0xdf, 0x00, 0x00 }, {       /* spell #32, PROP_CARD2_FILE_NUMBER(9439) */
        { 0 } } }, {
    ...
    { 0x06, 0x05, 0x04, 0x00, 0x01, 0x00 }, {                   /* spell #46, NotifyGUIEvent(1) */
        ...
        { 0x06, 0x05, 0x04, 0x00, 0x01, 0x01 },                 /* reply #46.3, PROP_GUI_STATE(1) */
        { 0x0e, 0x0c, 0x0a, 0x08, 0x11, 0x00, 0x15, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00 },/* reply #46.4, PD_NotifyOlcInfoChanged */
        { 0 } } }, {
