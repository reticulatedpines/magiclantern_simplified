...
static struct mpu_init_spell mpu_init_spells_50D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, {                       /* spell #1 */
        ...
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x00, 0x00 },           /* reply #1.13 */
...
//      { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 }, {           /* spell #19 */
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 },           /* reply #19.1 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x26, 0x00, 0x64, 0x00 }, {           /* spell #20 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x07, 0x10, 0x00 }, {                 /* spell #21, PROP_BURST_COUNT(16) */
        { 0 } } },
    { { 0x0a, 0x08, 0x03, 0x06, 0x00, 0x00, 0x02, 0xcd, 0x00 }, {/* spell #22 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x29, 0x07, 0x30, 0x00, 0x00 }, {     /* spell #23 */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x04, 0x0d, 0x01, 0x00 }, {                 /* spell #38 */
        ...
        { 0 } } },
    { { 0x32, 0x30, 0x05, 0x0d, 0xca, 0x38, 0xb2, 0xbd, 0x9e, 0xb7, 0xd1, 0x86, 0xc9, 0x38, 0x05, 0xd3, 0xe7, 0xca, 0xae, 0xa0, 0x39, 0xda, 0xc5, 0xc9, 0x2a, 0x07, 0xc9, 0x88, 0xa6, 0xd1, 0x28, 0x72, 0xd2, 0x60, 0xc8, 0xc7, 0x04, 0xd6, 0x62, 0x42, 0x47, 0x28, 0x29, 0xd7, 0x1a, 0xcf, 0x69, 0x09, 0x00 }, {/* spell #39 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, {                 /* spell #40 */
        { 0x08, 0x06, 0x05, 0x0d, 0x11, 0xa4, 0x00 },           /* reply #40.1 */
        { 0 } } },
    { { 0x32, 0x30, 0x05, 0x0d, 0xca, 0x38, 0xb2, 0xbd, 0x9e, 0xb7, 0xd1, 0x86, 0xc9, 0x38, 0x05, 0xd3, 0xe7, 0xca, 0xae, 0xa0, 0x39, 0xda, 0xc5, 0xc9, 0x2a, 0x07, 0xc9, 0x88, 0xa6, 0xd1, 0x28, 0x72, 0xd2, 0x60, 0xc8, 0xc7, 0x04, 0xd6, 0x62, 0x42, 0x47, 0x28, 0x29, 0xd7, 0x1a, 0xcf, 0x69, 0x09, 0x00 }, {/* spell #41 */
        { 0x08, 0x06, 0x05, 0x0d, 0x11, 0xa4, 0x00 },           /* reply #41.1 */
        { 0 } } },
    { { 0x32, 0x30, 0x05, 0x0d, 0xca, 0x38, 0xb2, 0xbd, 0x9e, 0xb7, 0xd1, 0x86, 0xc9, 0x38, 0x05, 0xd3, 0xe7, 0xca, 0xae, 0xa0, 0x39, 0xda, 0xc5, 0xc9, 0x2a, 0x07, 0xc9, 0x88, 0xa6, 0xd1, 0x28, 0x72, 0xd2, 0x60, 0xc8, 0xc7, 0x04, 0xd6, 0x62, 0x42, 0x47, 0x28, 0x29, 0xd7, 0x1a, 0xcf, 0x69, 0x09, 0x00 }, {/* spell #42 */
        { 0x06, 0x05, 0x04, 0x0d, 0x00, 0x00 },                 /* reply #42.1 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x01, 0x00 }, {                 /* spell #43 */
        { 0x06, 0x05, 0x03, 0x17, 0x9b, 0x00 },                 /* reply #43.1 */
        { 0x06, 0x05, 0x06, 0x00, 0x01, 0x00 },                 /* reply #43.2, GUI_Control:5, bindReceiveSwitch(0, 1) */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x00, 0x01, 0x00 }, {                 /* spell #44, NotifyGUIEvent(1) */
        { 0x18, 0x17, 0x0a, 0x08, 0x59, 0x00, 0x15, 0x00, 0x01, 0x00, 0x00, 0x4d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #44.1, PD_NotifyOlcInfoChanged */
        { 0x06, 0x05, 0x04, 0x00, 0x01, 0x01 },                 /* reply #44.2, PROP_GUI_STATE(1) */
        { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x04, 0x00, 0x00 }, {           /* spell #45, Complete WaitID = 0x80020000 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, {                 /* spell #46 */
        { 0x06, 0x05, 0x06, 0x0c, 0x01, 0x00 },                 /* reply #46.1, GUI_Control:4, bindReceiveSwitch(12, 1) */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x01, 0x7f, 0x00 }, {                 /* spell #47, PROP_ICU_UILOCK(7f) */
        { 0x06, 0x05, 0x04, 0x01, 0x7f, 0x00 },                 /* reply #47.1 */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x01, 0x00, 0x00 }, {                 /* spell #48, PROP_ICU_UILOCK(0) */
        { 0x06, 0x05, 0x04, 0x01, 0x00, 0x00 },                 /* reply #48.1 */
        { 0x06, 0x05, 0x06, 0x0e, 0x00, 0x00 },                 /* reply #48.2, bindReceiveSwitch(14, 0) */
     // { 0x06, 0x05, 0x06, 0x0e, 0x01, 0x00 },                 /* reply #48.3, GUISTATE_PLAYMENU, GUI_Control:1, bindReceiveSwitch(14, 1) */
        { 0x06, 0x05, 0x06, 0x0c, 0x01, 0x00 },                 /* reply #48.4, GUI_Control:4, bindReceiveSwitch(12, 1) */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x11, 0x02, 0x00 }, {                 /* spell #49 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x16, 0x01, 0x00 }, {                 /* spell #50 */
        { 0x06, 0x05, 0x03, 0x16, 0x00, 0x00 },                 /* reply #50.1 */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x01, 0x7b, 0x00 }, {                 /* spell #51, PROP_ICU_UILOCK(7b) */
        { 0x06, 0x05, 0x04, 0x01, 0x7b, 0x00 },                 /* reply #51.1 */
        { 0 } } },
    { { 0x06, 0x04, 0x04, 0x0a, 0x00 }, {                       /* spell #52 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x0c, 0x01, 0x00 }, {                 /* spell #53 */
        { 0x06, 0x05, 0x03, 0x0c, 0x01, 0x00 },                 /* reply #53.1 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x20, 0x00 }, {           /* spell #54 */
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x20, 0x00 },           /* reply #54.1 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x29, 0x00, 0x00, 0x00, 0x00 }, {     /* spell #55 */
        { 0 } } },
    { { 0x0a, 0x08, 0x03, 0x06, 0xff, 0xff, 0xff, 0xff, 0x00 }, {/* spell #56 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x00, 0x00 }, {           /* spell #57 */
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x00, 0x00 },           /* reply #57.1 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 }, {           /* spell #58 */
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 },           /* reply #58.1 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x26, 0x00, 0x64, 0x00 }, {           /* spell #59 */
        { 0 } } },
    { { 0x0a, 0x08, 0x03, 0x06, 0x00, 0x00, 0x02, 0xcd, 0x00 }, {/* spell #60 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x29, 0x07, 0x30, 0x00, 0x00 }, {     /* spell #61 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x0c, 0x00, 0x00 }, {                 /* spell #62 */
        { 0x06, 0x05, 0x03, 0x0c, 0x00, 0x00 },                 /* reply #62.1 */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x01, 0x00, 0x00 }, {                 /* spell #63, PROP_ICU_UILOCK(0) */
        { 0x06, 0x05, 0x04, 0x01, 0x00, 0x00 },                 /* reply #63.1 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x11, 0x01, 0x00 }, {                 /* spell #64 */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x01, 0x7f, 0x00 }, {                 /* spell #65, PROP_ICU_UILOCK(7f) */
        { 0x06, 0x05, 0x04, 0x01, 0x7f, 0x00 },                 /* reply #65.1 */
        { 0 } } },
    { { 0x06, 0x04, 0x04, 0x07, 0x00 }, {                       /* spell #66 */
        { 0x06, 0x05, 0x03, 0x17, 0x9b, 0x00 },                 /* reply #66.1 */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x01, 0x00, 0x00 }, {                 /* spell #67, PROP_ICU_UILOCK(0) */
        { 0x06, 0x05, 0x04, 0x01, 0x00, 0x00 },                 /* reply #67.1 */
        { 0x06, 0x05, 0x02, 0x0b, 0x00, 0x00 },                 /* reply #67.2 */
        { 0 } } },
