...
static struct mpu_init_spell mpu_init_spells_50D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        ...
        { 0x06, 0x05, 0x01, 0x20, 0x01, 0x00 },                 /* reply #1.7, PROP_CARD2_EXISTS */
        { 0x06, 0x05, 0x01, 0x21, 0x00, 0x00 },                 /* reply #1.8, PROP_CARD1_EXISTS */
        ...
        { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 },                 /* reply #1.17, PROP_CARD_SELECT */
        ...
        { 0x06, 0x05, 0x01, 0x48, 0x02, 0x00 },                 /* reply #1.24, PROP_LIVE_VIEW_ENABLE */
        { 0x06, 0x05, 0x01, 0x49, 0x00, 0x00 },                 /* reply #1.25, PROP_LIVE_VIEW_AF_MODE */
        { 0x06, 0x05, 0x01, 0x4b, 0x00, 0x00 },                 /* reply #1.26, PROP_LIVE_VIEW_MOVIE_SELECT */
        ...
        { 0x06, 0x05, 0x01, 0x39, 0x00, 0x00 },                 /* reply #1.35, PROP_EXTERNAL_FLASH_SETTINGS */
        ...
        { 0x08, 0x06, 0x01, 0x45, 0x00, 0x10, 0x00 },           /* reply #1.42, PROP_METERING_TIMER */
        { 0 } } },
...
//      { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 }, .description = "PROP_CARD1_STATUS", .out_spells = { /* spell #19 */
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 },           /* reply #19.1, PROP_CARD1_STATUS(01) */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x26, 0x00, 0x64, 0x00 }, .description = "PROP_CARD1_FOLDER_NUMBER", .out_spells = { /* spell #20 */
        { 0 } } },
 ...
 // { { 0x06, 0x05, 0x03, 0x16, 0x06, 0x00 }, .description = "PROP_BATTERY_CHECK", .out_spells = { 
    ...
    { { 0x06, 0x05, 0x03, 0x19, 0x01, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #42 */
        { 0x06, 0x05, 0x03, 0x17, 0x9b, 0x00 },                 /* reply #42.1 */
        { 0 } } },
