...
static struct mpu_init_spell mpu_init_spells_450D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        ...
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x00, 0x00 },           /* reply #1.10, PROP_CARD1_STATUS(0) */
    ...
    { { 0x06, 0x05, 0x03, 0x07, 0x00, 0x00 }, .description = "PROP_BURST_COUNT", .out_spells = { /* spell #16 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x27, 0x00, 0x64, 0x00 }, .description = "PROP_CARD1_FOLDER_NUMBER", .out_spells = { /* spell #17 */
        { 0 } } },
    ...
    { { 0x0a, 0x08, 0x03, 0x0b, 0x00, 0x00, 0x00, 0x01, 0x00 }, .description = "PROP 80030007", .out_spells = { /* spell #35 */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x27, 0x00, 0x64, 0x00 }, .description = "PROP_CARD1_FOLDER_NUMBER", .out_spells = { /* spell #36 */
        { 0 } } },
