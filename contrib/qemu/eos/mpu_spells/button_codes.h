...
static int button_codes_1100D[] = {
    ...
    [BGMT_PRESS_ZOOM_IN]                = 0x0901,
    [BGMT_PRESS_ZOOM_OUT]               = 0x0A01,
    [BGMT_Q]                            = 0x0501,   /* FIXME: 0x2001 in LiveView */
    [BGMT_TRASH]                        = 0x0401,   /* used in Canon menu; otherwise, it works as Av */
    [BGMT_UNPRESS_AV]                   = 0x1C00,
...
static int button_codes_550D[] = {
    ...
    [BGMT_PRESS_ZOOM_IN]                = 0x0901,
    [BGMT_PRESS_ZOOM_OUT]               = 0x0A01,
    [BGMT_Q]                            = 0x0501,   /* both Canon menu and LiveView, but Canon firmware also interprets 0x2001 as Q, why? */
    [BGMT_TRASH]                        = 0x0401,
    [BGMT_UNPRESS_AV]                   = 0x1C00,
    [BGMT_UNPRESS_DOWN]                 = 0x1900,
    [BGMT_UNPRESS_LEFT]                 = 0x1B00,
...
static int button_codes_5D3[] = {
    ...
    [BGMT_PRESS_ZOOM_IN]                = 0x0901,   /* internal; not present in logs, but firmware decodes it */
    [BGMT_PRESS_ZOOM_OUT]               = 0x0A01,   /* internal; not present in logs, but firmware decodes it */
...
static int button_codes_60D[] = {
    ...
    [BGMT_PRESS_ZOOM_IN]                = 0x0901,
    [BGMT_PRESS_ZOOM_OUT]               = 0x0A01,
    [BGMT_Q]                            = 0x2001,   /* 0501 is interpreted as "old Q" (PRESS_DIRECT_PRINT_BUTTON) in LiveView */
    [BGMT_TRASH]                        = 0x0401,
    [BGMT_UNLOCK]                       = 0x0501,   /* only used outside LiveView (i.e. in Canon menu) */
    [BGMT_UNPRESS_SET]                  = 0x0C00,
