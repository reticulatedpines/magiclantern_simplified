...
//  { 0x08, 0x06, 0x00, 0x00, 0x02, 0x0e, 0x00 }, {             /* spell #2, Complete WaitID = 0x80000001 */
    ...
    { 0x06, 0x04, 0x03, 0x10, 0x00 }, {                         /* spell #9 */
        { 0 } } }, {
    { 0x06, 0x05, 0x03, 0x07, 0xff, 0x00 }, {                   /* spell #10, PROP_BURST_COUNT(255) */
    ...
    { 0x0a, 0x08, 0x03, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00 }, { /* spell #12 */
        { 0 } } }, {
    { 0x08, 0x07, 0x01, 0x2a, 0x16, 0xf3, 0x00, 0x00 }, {       /* spell #13, PROP_CARD2_FILE_NUMBER(5875) */
        { 0 } } }, {
    { 0x06, 0x05, 0x03, 0x07, 0x0e, 0x00 }, {                   /* spell #14, PROP_BURST_COUNT(14) */
        { 0 } } }, {
    ...
    { 0x06, 0x05, 0x03, 0x69, 0x00, 0x00 }, {                   /* spell #52 */
        { 0 } } }, {
    { 0x08, 0x07, 0x01, 0x2a, 0x16, 0xf3, 0x00, 0x00 }, {       /* spell #53, PROP_CARD2_FILE_NUMBER(5875) */
        { 0 } } }, {
    { 0x08, 0x07, 0x01, 0x2a, 0x16, 0xf3, 0x00, 0x00 }, {       /* spell #54, PROP_CARD2_FILE_NUMBER(5875) */
        { 0 } } }, {
