...
static struct mpu_init_spell mpu_init_spells_70D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        ...
        { 0x34, 0x32, 0x02, 0x0f, 0x01, 0x00, 0x00, 0x10, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },/* reply #1.4, PROP_VIDEO_MODE */
...
//  { { 0x08, 0x06, 0x00, 0x00, 0x02, 0x0e, 0x00 }, .description = "Complete WaitID = 0x80000001", .out_spells = { /* spell #2 */
        ...
        { 0x06, 0x05, 0x01, 0x48, 0x01, 0x00 },                 /* reply #2.3, PROP_LIVE_VIEW_ENABLE */
        { 0x06, 0x05, 0x01, 0x49, 0x01, 0x00 },                 /* reply #2.4, PROP_LIVE_VIEW_AF_MODE */
        ...
        { 0x34, 0x32, 0x02, 0x0f, 0x01, 0x00, 0x00, 0x10, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },/* reply #2.7, PROP_VIDEO_MODE */
        ...
        { 0x0a, 0x09, 0x01, 0x55, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01 },/* reply #2.36, PROP_MULTIPLE_EXPOSURE */
        { 0 } } },
    ...
    { { 0x08, 0x07, 0x03, 0x6a, 0x00, 0x01, 0x00, 0x00 }, {     /* spell #6 */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x02, 0x0e, 0x00 }, .description = "Complete WaitID = 0x80000001", .out_spells = { /* spell #7 */
        { 0 } } },
    ...
    { { 0x0a, 0x08, 0x03, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00 }, .description = "PROP 80030007", .out_spells = { /* spell #12 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x2a, 0x16, 0xf3, 0x00, 0x00 }, .description = "PROP_CARD2_FILE_NUMBER", .out_spells = { /* spell #13 */
        { 0 } } },
    ...
    { { 0x08, 0x06, 0x03, 0x1f, 0x00, 0x00, 0x00 }, {           /* spell #36 */
        { 0x06, 0x05, 0x01, 0x58, 0x00, 0x00 },                 /* reply #36.1, PROP_VIDEO_SNAPSHOT */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x03, 0x1e, 0x00, 0x00 }, {                 /* spell #39 */
        { 0x06, 0x05, 0x01, 0x58, 0x00, 0x00 },                 /* reply #39.1, PROP_VIDEO_SNAPSHOT */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x23, 0x00, 0x00 }, {                 /* spell #40 */
        { 0 } } },
    { { 0x08, 0x06, 0x04, 0x24, 0x00, 0x00, 0x00 }, {           /* spell #41 */
        { 0x06, 0x05, 0x01, 0x58, 0x00, 0x00 },                 /* reply #41.1, PROP_VIDEO_SNAPSHOT */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x03, 0x69, 0x00, 0x00 }, {                 /* spell #52 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x2a, 0x16, 0xf3, 0x00, 0x00 }, .description = "PROP_CARD2_FILE_NUMBER", .out_spells = { /* spell #53 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x2a, 0x16, 0xf3, 0x00, 0x00 }, .description = "PROP_CARD2_FILE_NUMBER", .out_spells = { /* spell #54 */
        { 0 } } },
    ...
    { { 0x26, 0x24, 0x01, 0x4e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, .description = "PROP_VIDEO_MODE", .out_spells = { /* spell #57 */
        ...
        { 0x06, 0x05, 0x01, 0x58, 0x00, 0x00 },                 /* reply #57.3, PROP_VIDEO_SNAPSHOT */
        { 0x06, 0x05, 0x01, 0x59, 0x01, 0x00 },                 /* reply #57.4, PROP_MOVIE_SERVO_AF */
        { 0x06, 0x05, 0x01, 0x49, 0x01, 0x00 },                 /* reply #57.5, PROP_LIVE_VIEW_AF_MODE */
        { 0 } } },
    { { 0x26, 0x24, 0x01, 0x4e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, .description = "PROP_VIDEO_MODE", .out_spells = { /* spell #58 */
        ...
        { 0x06, 0x05, 0x01, 0x58, 0x00, 0x00 },                 /* reply #58.3, PROP_VIDEO_SNAPSHOT */
        { 0x06, 0x05, 0x01, 0x59, 0x01, 0x00 },                 /* reply #58.4, PROP_MOVIE_SERVO_AF */
        { 0x06, 0x05, 0x01, 0x49, 0x01, 0x00 },                 /* reply #58.5, PROP_LIVE_VIEW_AF_MODE */
        { 0 } } },
