...
//  { { 0x08, 0x06, 0x00, 0x00, 0x02, 0x0e, 0x00 }, .description = "Complete WaitID = 0x80000001", .out_spells = { /* spell #2 */
    ...
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, {                 /* spell #64 */
     ...
     // { 0x06, 0x05, 0x06, 0x00, 0x01, 0x00 },                 /* reply #64.2, BGMT_MENU, GUI_Control:6, bindReceiveSwitch(0, 1) */
        { 0 } } },
    { { 0x06, 0x05, 0x04, 0x00, 0x01, 0x00 }, .description = "NotifyGUIEvent", .out_spells = { /* spell #65 */
     ...
     // { 0x06, 0x05, 0x06, 0x09, 0x00, 0x00 },                 /* reply #65.2, BGMT_UNPRESS_ZOOM_IN, GUI_Control:15, bindReceiveSwitch(9, 0) */
        { 0x06, 0x05, 0x04, 0x00, 0x01, 0x01 },                 /* reply #65.3, PROP_GUI_STATE(1) */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x04, 0x00, 0x00 }, .description = "Complete WaitID = 0x80020000", .out_spells = { /* spell #66 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x34, 0x00, 0x00 }, {                 /* spell #67 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, {                 /* spell #68 */
     // { 0x06, 0x05, 0x06, 0x26, 0x01, 0x00 },                 /* reply #68.1, GMT_GUICMD_PRESS_BUTTON_SOMETHING, GUI_Control:84, bindReceiveSwitch(38, 1) */
