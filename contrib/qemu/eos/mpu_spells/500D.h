...
static struct mpu_init_spell mpu_init_spells_500D[] = {
 ...
 // { { 0x06, 0x05, 0x04, 0x00, 0x01, 0x00 }, .description = "NotifyGUIEvent", .out_spells = { 
     ...
     // { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x04, 0x00, 0x00 }, .description = "Complete WaitID = 0x80020000 NotifyGUIEvent", .out_spells = { /* spell #28 */
        { 0 } } },
 ...
 // { { 0x06, 0x05, 0x04, 0x00, 0x02, 0x00 }, .description = "NotifyGUIEvent", .out_spells = { 
     // { 0x24, 0x22, 0x0a, 0x08, 0x5f, 0x00, 0x01, 0x00, 0x01, 0x03, 0x98, 0x10, 0x00, 0x58, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x48, 0x04, 0x01, 0x00, 0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #30.1, PD_NotifyOlcInfoChanged */
     // { 0x06, 0x05, 0x04, 0x00, 0x02, 0xaa },                 /* reply #30.2, NotifyGUIEvent */
     // { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x04, 0x00, 0x00 }, .description = "Complete WaitID = 0x80020000 NotifyGUIEvent", .out_spells = { /* spell #30 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #31 */
     // { 0x06, 0x05, 0x06, 0x01, 0x01, 0x00 },                 /* reply #31.1, BGMT_INFO, GUI_Control:7, bindReceiveSwitch(1, 1) */
        { 0 } } },
 // { { 0x06, 0x05, 0x04, 0x00, 0x01, 0x00 }, .description = "NotifyGUIEvent", .out_spells = { 
     // { 0x20, 0x1e, 0x0a, 0x08, 0x57, 0x00, 0x0f, 0x00, 0x01, 0x00, 0x98, 0x10, 0x00, 0x58, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #32.1, PD_NotifyOlcInfoChanged */
     // { 0x0e, 0x0c, 0x0a, 0x08, 0x09, 0x00, 0x15, 0x00, 0x01, 0x00, 0x00, 0x48, 0x00 },/* reply #32.2, PD_NotifyOlcInfoChanged */
     // { 0x06, 0x05, 0x04, 0x00, 0x01, 0xaa },                 /* reply #32.3, NotifyGUIEvent */
     // { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x04, 0x00, 0x00 }, .description = "Complete WaitID = 0x80020000 NotifyGUIEvent", .out_spells = { /* spell #32 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #33 */
     // { 0x06, 0x05, 0x06, 0x00, 0x01, 0x00 },                 /* reply #33.1, BGMT_MENU, GUI_Control:6, bindReceiveSwitch(0, 1) */
        { 0 } } },
 // { { 0x06, 0x05, 0x04, 0x00, 0x00, 0x00 }, .description = "NotifyGUIEvent", .out_spells = { 
     // { 0x06, 0x05, 0x06, 0x09, 0x00, 0x00 },                 /* reply #34.1, BGMT_UNPRESS_ZOOM_IN, GUI_Control:12, bindReceiveSwitch(9, 0) */
     // { 0x06, 0x05, 0x06, 0x0a, 0x00, 0x00 },                 /* reply #34.2, BGMT_UNPRESS_ZOOM_OUT, GUI_Control:14, bindReceiveSwitch(10, 0) */
     // { 0x24, 0x22, 0x0a, 0x08, 0x5f, 0x00, 0x01, 0x00, 0x01, 0x03, 0x98, 0x10, 0x00, 0x58, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x48, 0x04, 0x01, 0x00, 0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },/* reply #34.3, PD_NotifyOlcInfoChanged */
     // { 0x06, 0x05, 0x04, 0x00, 0x00, 0xaa },                 /* reply #34.4, NotifyGUIEvent */
     // { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x04, 0x00, 0x00 }, .description = "Complete WaitID = 0x80020000 NotifyGUIEvent", .out_spells = { /* spell #34 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x01, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #35 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x01, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #36 */
        { 0 } } },
