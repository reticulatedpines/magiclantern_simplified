...
static struct mpu_init_spell mpu_init_spells_60D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        ...
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 },           /* reply #1.8, PROP_CARD1_STATUS(1) */
    ...
    { { 0x08, 0x06, 0x01, 0x24, 0x00, 0x01, 0x00 }, .description = "PROP_CARD2_STATUS", .out_spells = { /* spell #13 */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x27, 0x00, 0x64, 0x00 }, .description = "PROP_CARD1_FOLDER_NUMBER", .out_spells = { /* spell #14 */
        { 0 } } },
