...
static struct mpu_init_spell mpu_init_spells_60D[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        ...
        { 0x06, 0x05, 0x01, 0x20, 0x00, 0x00 },                 /* reply #1.2, PROP_CARD2_EXISTS */
        { 0x06, 0x05, 0x01, 0x21, 0x01, 0x00 },                 /* reply #1.3, PROP_CARD1_EXISTS */
        ...
        { 0x06, 0x05, 0x01, 0x42, 0x00, 0x00 },                 /* reply #1.15, PROP_STUDIO_MODE */
        ...
        { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 },                 /* reply #1.19, PROP_CARD_SELECT */
        { 0x06, 0x05, 0x01, 0x49, 0x01, 0x00 },                 /* reply #1.20, PROP_LIVE_VIEW_AF_MODE */
        { 0x06, 0x05, 0x01, 0x3e, 0x00, 0x00 },                 /* reply #1.21, PROP_SILENT_SHOOTING */
        { 0x08, 0x06, 0x01, 0x45, 0x00, 0x10, 0x00 },           /* reply #1.22, PROP_METERING_TIMER */
        { 0x06, 0x05, 0x01, 0x48, 0x01, 0x00 },                 /* reply #1.23, PROP_LIVE_VIEW_ENABLE */
        ...
        { 0x06, 0x05, 0x01, 0x48, 0x01, 0x00 },                 /* reply #1.29, PROP_LIVE_VIEW_ENABLE */
    ...
    { { 0x08, 0x06, 0x00, 0x00, 0x02, 0x00, 0x00 }, .description = "Complete WaitID = 0x80000001 Init", .out_spells = { /* spell #2 */
        { 0x08, 0x07, 0x01, 0x55, 0x00, 0x02, 0x01, 0x01 },     /* reply #2.1, PROP_MULTIPLE_EXPOSURE */
        { 0 } } },
    ...
    { { 0x08, 0x07, 0x01, 0x2a, ARG0, ARG1, 0x00, ARG2 }, .description = "PROP_CARD2_FILE_NUMBER", .out_spells = { /* spell #33 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x3d, 0x00, 0x00 }, .description = "PROP_VIDEO_SYSTEM", .out_spells = { /* spell #34 */
        { 0 } } },
