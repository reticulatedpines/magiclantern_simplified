...
static struct mpu_init_spell mpu_init_spells_60D[] = {
    ...
    { { 0x06, 0x05, 0x03, 0x40, 0x00, 0x00 }, {                 /* spell #12 */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x24, 0x00, 0x01, 0x00 }, .description = "PROP_CARD2_STATUS", .out_spells = { /* spell #13 */
        { 0x08, 0x06, 0x01, 0x24, 0x00, 0x01, 0x00 },           /* reply #13.1, PROP_CARD2_STATUS(01) */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x27, 0x00, 0x64, 0x00 }, .description = "PROP_CARD2_FOLDER_NUMBER", .out_spells = { /* spell #14 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x2a, 0x10, 0x31, 0x00, 0x00 }, .description = "PROP_CARD2_FILE_NUMBER", .out_spells = { /* spell #15 */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x03, 0x1e, 0x00, 0x00 }, {                 /* spell #32 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x2a, 0x10, 0x31, 0x00, 0x00 }, .description = "PROP_CARD2_FILE_NUMBER", .out_spells = { /* spell #33 */
        { 0 } } },
