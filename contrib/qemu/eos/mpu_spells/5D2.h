...
static struct mpu_init_spell mpu_init_spells_5D2[] = {
    { { 0x06, 0x04, 0x02, 0x00, 0x00 }, .description = "Init", .out_spells = { /* spell #1 */
        ...
        { 0x06, 0x05, 0x01, 0x20, 0x01, 0x00 },                 /* reply #1.2, PROP_CARD2_EXISTS */
        { 0x06, 0x05, 0x01, 0x21, 0x00, 0x00 },                 /* reply #1.3, PROP_CARD1_EXISTS */
        ...
        { 0x2c, 0x2a, 0x02, 0x00, 0x03, 0x03, 0x05, 0x00, 0x00, 0x00, 0x00, 0x48, 0x00, 0x00, 0x09, 0x17, 0x70, 0x00, 0x00, 0xfe, 0x00, 0x85, 0x07, 0x08, 0x01, 0x03, 0x06, 0x00, 0x00, 0x04, 0x07, 0x08, 0x01, 0x03, 0x01, 0x00, 0x00, 0x07, 0x08, 0x00, 0x73, 0x3b, 0x01 },/* reply #1.20, Init */
        { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 },                 /* reply #1.21, PROP_CARD_SELECT */
        { 0x06, 0x05, 0x01, 0x49, 0x00, 0x00 },                 /* reply #1.22, PROP_LIVE_VIEW_AF_MODE */
        { 0x06, 0x05, 0x01, 0x3e, 0x00, 0x00 },                 /* reply #1.23, PROP_SILENT_SHOOTING */
        { 0x08, 0x06, 0x01, 0x45, 0x00, 0x10, 0x00 },           /* reply #1.24, PROP_METERING_TIMER */
        { 0x06, 0x05, 0x01, 0x48, 0x02, 0x00 },                 /* reply #1.25, PROP_LIVE_VIEW_ENABLE */
        { 0x06, 0x05, 0x01, 0x4b, 0x02, 0x00 },                 /* reply #1.26, PROP_LIVE_VIEW_MOVIE_SELECT */
    ...
    { { 0x06, 0x05, 0x01, 0x22, 0x00, 0x00 }, .description = "PROP_CARD3_EXISTS", .out_spells = { /* spell #4 */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x25, 0x00, 0x00, 0x00 }, .description = "PROP_CARD3_STATUS", .out_spells = { /* spell #5 */
        { 0x08, 0x06, 0x01, 0x25, 0x00, 0x00, 0x00 },           /* reply #5.1, PROP_CARD3_STATUS(00) */
        { 0 } } },
    { { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 }, .description = "PROP_CARD_SELECT", .out_spells = { /* spell #6 */
        { 0x06, 0x05, 0x01, 0x37, 0x00, 0x00 },                 /* reply #6.1, PROP_CARD_SELECT */
        { 0x0a, 0x08, 0x01, 0x34, 0x08, 0x01, 0x07, 0x03, 0x01 },/* reply #6.2, PROP_PIC_QUALITY1 */
        { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x01, 0x34, 0x00 }, .description = "Complete WaitID = 0x8000002F PROP_PIC_QUALITY1", .out_spells = { /* spell #7 */
        { 0x0a, 0x08, 0x01, 0x35, 0x00, 0x00, 0x06, 0x04, 0x01 },/* reply #7.1, PROP_PIC_QUALITY2 */
        { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x01, 0x35, 0x00 }, .description = "Complete WaitID = 0x80000030 PROP_PIC_QUALITY2", .out_spells = { /* spell #8 */
        { 0x0a, 0x08, 0x01, 0x36, 0x08, 0x01, 0x07, 0x03, 0x01 },/* reply #8.1, PROP_PIC_QUALITY3 */
        { 0 } } },
    { { 0x08, 0x06, 0x00, 0x00, 0x01, 0x36, 0x00 }, .description = "Complete WaitID = 0x80000031 PROP_PIC_QUALITY3", .out_spells = { /* spell #9 */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x04, 0x0e, 0x00, 0x00 }, {                 /* spell #15 */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x25, 0x00, 0x00, 0x00 }, .description = "PROP_CARD3_STATUS", .out_spells = { /* spell #16 */
        { 0x08, 0x06, 0x01, 0x25, 0x00, 0x00, 0x00 },           /* reply #16.1, PROP_CARD3_STATUS(00) */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 }, .description = "PROP_CARD1_STATUS", .out_spells = { /* spell #17 */
        { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 },           /* reply #17.1, PROP_CARD1_STATUS(01) */
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x26, 0x00, 0x64, 0x00 }, .description = "PROP_CARD1_FOLDER_NUMBER", .out_spells = { /* spell #18 */
        { 0 } } },
    ...
    { { 0x06, 0x05, 0x02, 0x0a, 0x00, 0x00 }, {                 /* spell #23 */
        ...
        { 0x06, 0x05, 0x01, 0x39, 0x00, 0x00 },                 /* reply #23.8, PROP_EXTERNAL_FLASH_SETTINGS */
 ...
 // { { 0x06, 0x05, 0x03, 0x16, 0x06, 0x00 }, .description = "PROP_BATTERY_CHECK", .out_spells = { 
    ...
    { { 0x06, 0x05, 0x04, 0x0d, 0x01, 0x00 }, .description = "PROP_ACTIVE_SWEEP_STATUS", .out_spells = { /* spell #42 */
        ...
        { 0x06, 0x05, 0x04, 0x15, 0x00, 0x00 },                 /* reply #42.2 */
        { 0x06, 0x05, 0x03, 0x17, 0x92, 0x00 },                 /* reply #42.3 */
        { 0 } } },
    { { 0x06, 0x05, 0x03, 0x19, 0x00, 0x00 }, .description = "PROP_TFT_STATUS", .out_spells = { /* spell #43 */
     // { 0x06, 0x05, 0x03, 0x17, 0x92, 0x00 },                 /* reply #43.1, delayed by 798 ms, likely external input */
        { 0 } } },
