...
static struct mpu_init_spell mpu_init_spells_5D2[] = {
    ...
    { { 0x08, 0x06, 0x01, 0x25, 0x00, 0x00, 0x00 }, {           /* spell #16 */
        ...
        { 0 } } },
    { { 0x08, 0x06, 0x01, 0x23, 0x00, 0x01, 0x00 }, .description = "PROP_CARD1_STATUS", .out_spells = { /* spell #17 */
    ...
    { { 0x0a, 0x08, 0x03, 0x06, 0x00, 0x00, 0x08, 0x18, 0x00 }, .description = "PROP_AVAIL_SHOT", .out_spells = { /* spell #20 */
        { 0 } } },
    { { 0x08, 0x07, 0x01, 0x29, 0x02, 0xf9, 0x00, 0x00 }, .description = "PROP_CARD1_FILE_NUMBER", .out_spells = { /* spell #21 */
        { 0 } } },
