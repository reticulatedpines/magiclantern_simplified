...
ptp_get_operation_name(PTPParams* params, uint16_t oc)
{
	...
	static struct {
                ...
                {PTP_OC_CANON_AdapterTransferProgress,      N_("CANON EOS AdapterTransferProgress")},
                ...
                {PTP_OC_CANON_CancelTransfer2,              N_("CANON EOS CancelTransfer2")},
                ...
                {PTP_OC_CANON_ExecuteEventProc,             N_("CANON EOS ExecuteEventProc")},
                ...
                {PTP_OC_CANON_GetEventProcReturnData,       N_("CANON EOS GetEventProcReturnData")},
                ...
                {PTP_OC_CANON_IsEventProcRunning,           N_("CANON EOS IsEventProcRunning")},
                {PTP_OC_CANON_KeepDeviceON,                 N_("CANON EOS KeepDeviceON")},
                {PTP_OC_CANON_LoadTransparentMemory,        N_("CANON EOS LoadTransparentMemory")},
                ...
                {PTP_OC_CANON_NotifyAdapterStatus,          N_("CANON EOS NotifyAdapterStatus")},
                {PTP_OC_CANON_NotifyUpdateProgress,         N_("CANON EOS NotifyUpdateProgress")},
                {PTP_OC_CANON_PCHDDCapacity,                N_("CANON EOS PCHDDCapacity")},
                {PTP_OC_CANON_PopupBuiltinFlash,            N_("CANON EOS PopupBuiltinFlash")},
                {PTP_OC_CANON_QuerySizeOfTransparentMemory, N_("CANON EOS QuerySizeOfTransparentMemory")},
                ...
                {PTP_OC_CANON_SaveTransparentMemory,        N_("CANON EOS SaveTransparentMemory")},
                ...
                {PTP_OC_CANON_TransferComplete2,            N_("CANON EOS TransferComplete2")},
