...
** avoids including 'dryos.h' everywhere.)
*/
#if defined(LUA_LIB) || defined(lua_c)
//#include <dryos.h>
#define luai_writestring(s,l) do_fwrite((s), sizeof(char), (l), stdout)
...
*/
#define luai_writestringerror(s,p)	(do_fprintf(stderr, (s), (p)), do_fflush(stderr))
