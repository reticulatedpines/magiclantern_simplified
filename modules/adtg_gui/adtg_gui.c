...
static unsigned int adtg_gui_init()
{
    ...
    else if (streq(camera_model_short, "500D")) // http://www.magiclantern.fm/forum/index.php?topic=6751.msg70325#msg70325
    {
        ADTG_WRITE_FUNC = 0xFF22F8F4; //"[REG] @@@@@@@@@@@@ Start ADTG[CS:%lx]"
        CMOS_WRITE_FUNC = 0xFF22F9DC; //"[REG] ############ Start CMOS"
    }
    else if (streq(camera_model_short, "550D")) // http://www.magiclantern.fm/forum/index.php?topic=6751.msg61551#msg61551
    {
        ADTG_WRITE_FUNC = 0xff27ee34;
        CMOS_WRITE_FUNC = 0xff27f028;
    }
    else if (streq(camera_model_short, "60D")) // http://www.magiclantern.fm/forum/index.php?topic=6751.msg69719#msg69719
    {
    ...
    else if (streq(camera_model_short, "6D")) // from 1%
    {
    ...
    else if (streq(camera_model_short, "EOSM")) // from 1%
    {
        ADTG_WRITE_FUNC = 0x2986C;
        CMOS_WRITE_FUNC = 0x2998C;
    }
    else if (streq(camera_model_short, "600D")) // from 1% TL 2.0
    {
...
MODULE_STRINGS_START()
    MODULE_STRING("Description", "ADTG register editing GUI")
    MODULE_STRING("License", "GPL")
    MODULE_STRING("Author", "a1ex")
    MODULE_STRING("Credits", "g3gg0 (adtg_log)")
MODULE_STRINGS_END()
