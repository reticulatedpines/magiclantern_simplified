 ...
 */
extern unsigned int ime_base_start ( char *text, int max_length, int charset, t_ime_update_cbr update, int x, int y, int w, int h );
typedef unsigned int (*t_ime_start) ( char *text, int max_length, int charset, t_ime_update_cbr update, int x, int y, int w, int h );
