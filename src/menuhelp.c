...
draw_beta_warning()
{
    ...
    bmp_printf(FONT_MED | FONT_ALIGN_CENTER(720), 0, 150, "This is a development snapshot for testing purposes.");

    bmp_printf(FONT_MED | FONT_ALIGN_CENTER(720), 0, 200, "Please report all bugs at www.magiclantern.fm.");

    bmp_printf(FONT_MED | FONT_ALIGN_CENTER(720), 0, 250, "Be careful using it for production work.      ");

    bmp_printf(FONT_MED | FONT_ALIGN_CENTER(720), 0, 300, "Enjoy!");
