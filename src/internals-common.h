...
/* DIGIC families */
  ...
  #define CONFIG_DIGIC_8X       /* these are mostly identical */
#endif

#if defined(CONFIG_DIGIC_VII) || defined(CONFIG_DIGIC_VIII) || defined(CONFIG_DIGIC_X)
  #define CONFIG_DIGIC_78X       /* these are mostly identical */
#endif

#if defined(CONFIG_DIGIC_VI) || defined(CONFIG_DIGIC_VII) || defined(CONFIG_DIGIC_VIII) || defined(CONFIG_DIGIC_X)
  #define CONFIG_DIGIC_678X      /* these are also very similar, more often than not */
#endif
